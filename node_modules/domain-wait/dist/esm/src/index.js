...
var nodeData = null;
export function addDomainWait(nodeServicesBootFuncParams) {
...
export function wait(taskFn, taskKey) {
    return __awaiter(this, void 0, void 0, function () {
        var _completedTasks, completedTaskIndex, state_1, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (_completedTasks) {
                        completedTaskIndex = _completedTasks.indexOf(taskKey);
                        ...
                        console.log("domain-wait: Array \"window." + completedTasksKey + "\" not defined. Define it to use the \"wait\" method. This will prevent the execution of methods on client side after SSR.");
                    }
                    return [4, taskFn(transformUrl)];
                case 1:
                    _a.sent();
